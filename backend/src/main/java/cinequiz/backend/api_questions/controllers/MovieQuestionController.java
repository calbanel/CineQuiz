...
public class MovieQuestionController {
    ...
    public ResponseEntity<?> random_question(
        ...
        int randomQuestion = random(1, NB_DEFINED_QUESTIONS);
    ...
    private MovieInfos getMovieIfValid(MovieListResult result, String tmdbLanguage, MovieTmdbFetchOptions options)
    ...
    private ArrayList<MovieCast> getFiltredCastListInPage(MovieCastPage page,
